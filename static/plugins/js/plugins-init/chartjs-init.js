 ...
 var dlabSparkLine = function(){
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(41, 83, 232, 1)");
			barChart_3gradientStroke.addColorStop(1, "rgba(41, 83, 232, 0.5)");
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(1, "rgba(41, 83, 232, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(41, 83, 232, 0.5)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(41, 83, 232, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(41, 83, 232, 0.5)");

			const lineChart_3gradientStroke2 = lineChart_3.createLinearGradient(500, 0, 100, 0);
			lineChart_3gradientStroke2.addColorStop(0, "rgba(255, 171, 45, 1)");
			lineChart_3gradientStroke2.addColorStop(1, "rgba(255, 171, 45, 1)");
					...
					datasets: [
						{
							...
							borderWidth: "1",
							backgroundColor: 'rgba(41, 83, 232, .5)', 
				...
				data: {
					...
					datasets: [
						...
						}, 
						{
							...
							borderColor: 'rgb(255, 171, 45)',
							borderWidth: "1",
							backgroundColor: 'rgba(255, 171, 45, .5)'
						}
					]
				},
				options: {
